...
//This exports a db object that can be used to interact with the ORM
//Any files in path src/models get sourced in and hooked up per:
// http://sequelize.readthedocs.io/en/1.7.0/articles/express/

var fs        = require("fs");
var path      = require("path");
var Sequelize = require("sequelize");
var sequelize = new Sequelize("fbank", "root", "dev", { host: "localhost" });
