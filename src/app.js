...
// This may not be required and is deprecated past 1.5.0 - needs further review:
...
// currently links to bootstrap and jquery -> will link in through app later
...
//app.get('/userhome', application.IsAuthenticated, userhome.userhome)
